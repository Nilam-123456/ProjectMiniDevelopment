...
public class Editor extends Frame
    {
     ...
     Editor()
		 ...
		 MenuItem m1 =new MenuItem("Word Wrap          ");
	     MenuItem m2 =new MenuItem("Font...            ");
		 f.add(m1);
         f.add(m2);
		 mb.add(f);

		 Menu v=new Menu("View");
		 MenuItem m21=new MenuItem("Staus Bar           ");
		 v.add(m21);
		 mb.add(v);

		 Menu h=new Menu("help");
		 MenuItem m22=new MenuItem("View Help    ");
	     MenuItem m23=new MenuItem("About Notepad");
		 h.add(m22);
         h.add(m23);
		 mb.add(h);
